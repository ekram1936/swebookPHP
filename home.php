      ...
      <div class="container text-center">
        <div class="row">
          <div class="col-md-6 col-12">
            <div class="pray">
              <img src="./pexels-photo-179941.jpeg" alt="Pray" class="" />
            </div>
          </div>
          <div class="col-md-6 col-12">
          ...
          <div class="d-flex flex-row justify-content-center flex-wrap">
            <div class="card">
              <div class="card-body">
                ...
                <div class="pricing">
                  <h1>Free</h1>
                  <a href="pdf.php" class="btn btn-dark px-5 py-2 primary-btn mb-5">Read Now</a>
                </div>
              </div>
            </div>
            <div class="card">
              <div class="card-body">
                ...
                <div class="pricing">
                  <h1>Free</h1>
                  <a href="#" class="btn btn-dark px-5 py-2 primary-btn mb-5">Read Now</a>
                </div>
              </div>
            </div>
            <div class="card">
